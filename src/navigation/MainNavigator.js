...
import EarningScreen from '../modules/Auth/BottomNavigation/screens/Earning/EarningScreen';
  ...
  return (
    <React.Fragment>
      <Drawer.Navigator
        ...
        />
        <Drawer.Screen
          name={data ? eng.packages : Urdu.packages}
          component={PackagesStack}
          options={{
            drawerIcon: () => (
              <Image
        ...
        />
        <Drawer.Screen
          name={data ? eng.myBids : Urdu.myBids}
        ...
        />
        <Drawer.Screen
          name={data ? eng.MyProfile : Urdu.MyProfile}
        ...
        />
        {/* <Drawer.Screen
          name={data ? eng.insuredLuggage : Urdu.insuredLuggage}
        ...
        /> */}
        <Drawer.Screen
          name={data ? eng.myEarning : Urdu.myEarning}
          component={MyEarningStack}
          options={{

            drawerIcon: () => (
              <Image
                source={require('../modules/Auth/SideNavigation/Images/Icons/My_Earnings.png')}
        ...
        <Drawer.Screen
          name={data ? eng.payment : Urdu.payment}
        ...
        />
        {/* <Drawer.Screen
          name={data ? eng.share : Urdu.share}
          component={Share}
          options={{
            drawerIcon: () => (
              <Image
        ...
        /> */}
        <Drawer.Screen
          name={data ? eng.contactUs : Urdu.contactUs}
        ...
        />
        {/* <Drawer.Screen
          name={data ? eng.rateUs : Urdu.rateUs}
          component={Rate_us}
          options={{
            drawerIcon: () => (
              <Image
