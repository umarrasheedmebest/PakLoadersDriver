...
function MyBidsStack() {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name='MyBidsStack' component={My_bids}
        options={{
          headerTitle: 'My Bids',
          headerLeft: () => (
            <View style={{ marginLeft: 5, }}>
...
function MyProfileStack() {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen name="A_Vehicle" component={A_Vehicle} options={{
        headerTitle: 'Edit / Update Vehicle'
      }} />
      <Stack.Screen name="Packages" component={PackagesStack} options={{
        headerShown: false,
      }} />
      ...
      <Stack.Screen name="Struck" component={Struck} options={{
        headerTitle: 'Select Vehicle'
      }} />
      <Stack.Screen name="VDetails" component={VDetails} options={{
        headerTitle: 'Select Vehicle'
      }} />
      <Stack.Screen name="A_Vehicle_Verified" component={A_Vehicle_Verified} options={{
        headerShown: false
      }} />
    </Stack.Navigator>
  )
...
function MyRidesStack() {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name='MyRidesStack' component={My_rides}
        options={{
          headerTitle: 'Rides',
          headerLeft: () => (
            <View style={{ marginLeft: 5, }}>
      ...
      {/* ONGOING SCREENS */}
      <Stack.Screen name="ViewDetails" component={ViewDetails} options={{
        headerTitle: 'Rides',
      }} />
      <Stack.Screen name="TripDetails" component={TripDetails} options={{
        headerTitle: 'View Details',
      }} />
      <Stack.Screen name="TripStarts" component={TripStarts} options={{
        headerTitle: 'View Details',
      }} />

      {/* UPCOMING SCREENS */}
      <Stack.Screen name='UpComing_ViewDetails' component={UpComing_ViewDetails} options={{
        headerTitle: 'Rides',
      }} />

      <Stack.Screen name='UpComing_TripDetails' component={UpComing_TripDetails} options={{
        headerTitle: 'View Details',
      }} />

      {/* COMPLETED SCREEN */}
      <Stack.Screen name='Completed_TripDetails' component={Completed_TripDetails} options={{
        headerTitle: 'View Details',
      }} />
...
function PaymentsStack() {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name='PaymentsStack' component={Payments}
        options={{
      ...
      <Stack.Screen name='Pcredit' component={Pcredit} options={{
        headerTitle: 'Credit / Debit Card'
      }} />
      <Stack.Screen name='Easypay' component={Easypay} options={{
        headerTitle: 'Easy Paisa'
      }} />
      <Stack.Screen name='Jazzcash' component={Jazzcash} options={{
...
function ContactUsStack() {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name='ContactUsStack' component={ContactUS}
        options={{
  ...
  return (
    <React.Fragment>
      <Drawer.Navigator initialRouteName="NavigationToScreens" drawerContent={props => <CustomDrawer {...props} />}
        ...
        <Drawer.Screen name="Packages" component={PackagesStack}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Packages.png')} />
            )
          }} />
        <Drawer.Screen name="My Bids" component={MyBidsStack}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/My_bids.png')} />
            )
          }} />
        <Drawer.Screen name="My Profile" component={MyProfileStack}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Rate_us.png')} />
            )
          }} />
        <Drawer.Screen name="Insured Languages" component={Insured_Languages}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Insured_language.png')} />
            )
          }} />
        <Drawer.Screen name="My Rides" component={MyRidesStack}
          options={{
            title: 'Rides',
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/My_rides.png')} />
            )
          }} />
        <Drawer.Screen name="Chat" component={ChatStack}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Chat.png')} />
            )
          }} />
        <Drawer.Screen name="Payments" component={PaymentsStack}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Payment.png')} />
            )
          }} />
        <Drawer.Screen name="Share" component={Share}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Share.png')} />
            )
          }} />
        <Drawer.Screen name="Contact Us" component={ContactUsStack}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Contact_us.png')} />
            )
          }} />
        <Drawer.Screen name="Rate us" component={Rate_us}
          options={{
            drawerIcon: () => (
              <Image source={require('../modules/Auth/SideNavigation/Images/Icons/Rate_us.png')} />
            )
