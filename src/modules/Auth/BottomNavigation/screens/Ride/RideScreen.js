      ...
      <View
        ...
        <View style={{ flex: 1, margin: 10 }}>
          ...
          <View
            ...
            <TextInput value={input} onChangeText={(text) => setInput(text)} placeholder={data ? eng.search : Urdu.search} marginRight="auto" />
          ...
          <View>
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                // if (item.dropoff_address.toLocaleLowerCase().includes(input.toLocaleLowerCase())) {
                //   return dataCards({ item })
                // }
                if (dateTime.includes(input.toLowerCase())) {
                  // Do something with the dataCards and item here
                  return dataCards({ item });
                }
              }}
            />
