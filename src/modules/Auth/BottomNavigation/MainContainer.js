...
import { MyRidesStack } from '../../../navigation/MainNavigator';
...
export default function MainContainer() {
  return (
    ...
    >
      ...
      /> */}
       <Tab.Screen name='My Rides' component={MyRidesStack}
        options={{
          // headerTitle: 'EarningScreen',
          headerShown: false,
          tabBarIcon: ({ focused }) => (
            <View style={{ alignItems: 'center', justifyContent: 'center', }}>
              <Image source={focused ? require('../BottomNavigation/Images/BottomNavigationIcons/My_rides.png') : require('../BottomNavigation/Images/BottomNavigationIcons/My_rides2.png')}
                resizeMode='contain' style={{ width: 34, height: 34,  }} />
              <Text style={{ color: focused ? '#4448FF' : '#E1E1FF', fontSize: 12, padding: 10, fontFamily: 'Montserrat_500Medium' }}>My Rides</Text>
            </View>
          )
        }}
      /> 
