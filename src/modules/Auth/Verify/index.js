          ...
          <ScrollView>
            <View style={{paddingVertical: 35, paddingHorizontal: 15}}>
              ...
              <Text
                ...
                {data ? eng.accountVerification : Urdu.accountVerification}
              </Text>
              {/* OTp Message */}
              <Text
              ...
              <View
                ...
                <Text>{data ? eng.veriCode : Urdu.veriCode}</Text>
                <TouchableOpacity>
                  <Text
                    style={{
                      color: '#444BFF',
                    ...
                    {data ? eng.sendAgain : Urdu.sendAgain}
                  </Text>
                </TouchableOpacity>
              </View>
