                ...
                <View style={{
                    ...
                    <Modal transparent={true} visible={modalVisible} onRequestClose={() => setModalVisible(true)} >
                        <View style={{ flex: 1, backgroundColor: '#000000aa', alignItems: 'center', }}>
                            ...
                            {/* background white  */}
                            <View style={{ backgroundColor: 'white', borderRadius: 10, padding: 20, margin: 20, marginTop: 35, }}>

                                {/* Detail Text */}
                                <Image source={require('../../../assets/Payment/jazzcash_modalLogo.png')}
                                    style={{ alignSelf: 'center' }} />
                                <Text style={{ textAlign: 'center', marginTop: 30 }}>Pay with your Jazzcash account. Enter the Jazzcash registered mobile number</Text>
                                <Text style={{ marginTop: 5, textAlign: 'center', color: '#444BFF' }}>Note: Ensure your Jazzcash account is active and has sufficient balance.</Text>
...
export default JazzcashComponent;