                    ...
                    <View style={{ flex: 1, margin: 20, marginTop: 20, }}>
                        ...
                        <View style={style.cardDesign}>
                            ...
                            <View>
                                ...
                                <Text style={{ fontSize: 12 }}>PK87324264823</Text>
                            </View>
                            <View>
                    ...
                    <Modal transparent={true} visible={modalVisible} onRequestClose={() => setModalVisible(true)} >
                        <View style={{ flex: 1, backgroundColor: '#000000aa', alignItems: 'center', }}>
                            ...
                            <View style={{ backgroundColor: 'white', marginTop: 35, borderRadius: 10, padding: 20, margin: 20, }}>
                                ...
                                {/* Detail Text */}
                                <Image source={require('../../../assets/Payment/bank_modalLogo.png')}
                                    style={{ alignSelf: 'center' }} />
                                <Text style={{ textAlign: 'center', marginTop: 30 }}>Pay with your Bank account. Enter the Account details.</Text>
                                <Text style={{ marginTop: 5, textAlign: 'center', color: '#444BFF' }}>Note: Ensure your Bank account is active and has sufficient balance.</Text>
