      ...
      <View style = {{flex: 1}}>
        ...
        // ,padding:100, 
         ...
         <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('TripStarts')}>
            <Text style= {{
            fontSize: 14,paddingVertical: 10, paddingHorizontal: 40,            
              color: 'white', borderWidth: 2, borderColor: '#4448FF', backgroundColor: '#4448FF', 
              borderRadius: 10, marginLeft: 10,}}>Start</Text>
          </TouchableOpacity>
