                    ...
                    <View style={{ flex: 1, margin: 20, marginTop: 20 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            ...
                            <TouchableOpacity
                                ...
                                <Text style={isActivebtn1 ? style2.textColor : style2.textColor2}>Essential</Text>
                                <Text style={isActivebtn1 ? style2.textColor : style2.textColor2}>4 Features</Text>
                            </TouchableOpacity>

                            <TouchableOpacity
                                onPress={onPressbtn2}
                                style={isActivebtn2 ? style2.btnSelect : style2.btnUnselect}>
                                <Text style={isActivebtn2 ? style2.textColor : style2.textColor2}>Prefered</Text>
                                <Text style={isActivebtn2 ? style2.textColor : style2.textColor2}>7 Features</Text>
                            </TouchableOpacity>

                            <TouchableOpacity
                                onPress={onPressbtn3}
                                style={isActivebtn3 ? style2.btnSelect : style2.btnUnselect}>
                                <Text style={isActivebtn3 ? style2.textColor : style2.textColor2}>Ultimate</Text>
                                <Text style={isActivebtn3 ? style2.textColor : style2.textColor2}>13 Features</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <Text style={{ color: '#4448FF', fontSize: 18, marginTop: 20 }}>Unlock 4 Powerful Features</Text>
                        ...
                        <View style={{ flexDirection: "row", marginTop: 25, }}>
                            <Image source={require('../../../../../../../../assets/Packages/premium_icon.png')}
                                style={{ width: 18, height: 25 }} />
                            <View style={{ marginLeft: 10, }}>
                                <Text style={{ fontSize: 14 }}>Days to Pay & Credit Score</Text>
                                <Text style={{ fontSize: 10, color: '#A5A5A5', marginTop: 5 }}>Lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem Lorem ipsum lorem ipsum lorem ipsum ....</Text>
                            </View>
                        </View>
                        {/* Live Load Updates */}
