...
import { Text, View, Image, ImageBackground, TouchableOpacity, Modal, navigation } from "react-native";
    ...
    return (
        ...
        <View style={{ flex: 1 }}>
            <DrawerContentScrollView {...props} contentContainerStyle={{ backgroundColor: 'white', }}>
                <UpperDesignCode />
                <View style={{ flex: 1, backgroundColor: 'white', paddingTop: 15, borderRadius: 35, margin: -10, }}>
                    ...
                    <TouchableOpacity onPress={() => setModalVisible(true)}
                        style={{ flexDirection: 'row', marginBottom: 40, marginLeft: 20, marginTop: 3 }}>
                        <Image source={require('../Images/Icons/Logout.png')} />
                        <Text style={{ alignSelf: "center", marginLeft: 25, fontFamily: 'Montserrat_500Medium', fontSize: 16 }}>Log Out</Text>
                    </TouchableOpacity>
                    {/*Contact us*/}
                    <Text style={{ alignSelf: "center", marginBottom: 20, fontFamily: 'Montserrat_500Medium', fontSize: 14 }}>CONNECT US AT</Text>
                    {/*Social Media*/}
                    <View style={{ flexDirection: "row", marginBottom: 20, alignSelf: "center" }}>
                        <Image source={require('../Images/SocialMedia/Facebook.png')} />
                        <Image source={require('../Images/SocialMedia/Instagram.png')} style={{ marginHorizontal: 18 }} />
            ...
            <Modal transparent={true} visible={modalVisible} onRequestClose={() => setModalVisible(true)} >
                <View style={{ flex: 1, backgroundColor: '#000000aa', justifyContent: "center" }}>
                    ...
                    {/* background white  */}
                    <View style={{
                        backgroundColor: 'white', borderRadius: 10, padding: 20, margin: 20, marginTop: 35,
                        alignItems: "center",
                    }}>
                        {/* Logout Text */}
                        <Text style={{ marginLeft: 10, color: '#f44336', fontSize: 15 }}>Logout</Text>

                        <Text style={{ fontSize: 14, alignSelf: 'center', marginTop: 20, fontWeight: 'bold', color: '#5a5a5a' }}>Are you sure you want to logout!!</Text>
