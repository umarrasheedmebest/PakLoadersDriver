                ...
                <View style={{ flex: 1, margin: 30, }}>
                    ...
                    <View style={{ marginBottom: 20, alignSelf: 'baseline', alignItems: 'center', alignSelf: 'center' }}>
                        <TouchableOpacity onPress={() => updateUserImage()}>
                            <Image style={{ width: 94, height: 94, borderRadius: 100 }}
                                source={item.driver_image ?
                                    {
                                        uri: `${BASE_URL}images/${item.driver_image}`
                                    } :
                                    require('../../../assets/MyProfile_Icons/Profile_Pic.png')
                                }
                            />
                    ...
                    <View style={{ alignSelf: 'center' }}>
                        <View style={{ marginTop: 25, alignSelf: 'baseline', }}>
                            {/* Submit Button  */}
                            <TouchableOpacity onPress={() => myProfileFun()}>
                                <Text style={{
