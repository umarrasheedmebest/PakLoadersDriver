...
import unselectImage from '../../../assets/A_Vehicle/unselect.png';
import selectImage from '../../../assets/A_Vehicle/select.png';
                    ...
                    <View style={{ flex: 1, margin: 20, marginTop: 20 }}>
                        ...
                        <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "space-around", }}>
                            ...
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(0)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselected image */}
                                    <Image source={selectedCardIndex === 0 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(1)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselected image */}
                                    <Image source={selectedCardIndex === 1 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                        ...
                        <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "space-around" }}>
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(2)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 2 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(3)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 3 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                        ...
                        <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "space-around" }}>
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(4)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 4 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(5)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 5 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                        ...
                        <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "space-around" }}>
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(6)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 6 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(7)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 7 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                        ...
                        <View style={{ flexDirection: "row", marginTop: 20, justifyContent: "space-around" }}>
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(8)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 8 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
                            ...
                            {/* Card Design Box */}
                            <View style={{ elevation: 5, backgroundColor: 'white', borderRadius: 15, marginBottom: 15, padding: 10 }}>
                                <TouchableOpacity onPress={() => handleCardPress(9)} style={{ alignItems: "center", maxWidth: 130, minWidth: 130 }}>
                                    {/* unselect image */}
                                    <Image source={selectedCardIndex === 9 ? selectImage : unselectImage} style={{ alignSelf: "flex-end" }} />
