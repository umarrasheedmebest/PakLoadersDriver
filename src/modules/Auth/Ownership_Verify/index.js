...
const Ownership_Verifycomponent = ({ navigation }) => {
            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <View style={{
                    ...
                    <ScrollView>
                        ...
                        {/* Sign Up Button */}
                        <TouchableOpacity style={{ alignSelf: "center", marginTop: 50 }} onPress={()=>navigation.navigate('Ownership_Verified')}>
                            <Text style={{
...
export default Ownership_Verifycomponent;
